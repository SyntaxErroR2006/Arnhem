...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission("BAN_MEMBERS")) return message.reply(":x: U kunt dit niet doen.");
    if (!message.guild.me.hasPermission("BAN_MEMBERS")) return message.reply(":x: U kunt dit niet doen.");
